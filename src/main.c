...
unsigned char pic[]=
{/*--  ������һ��ͼ����E:\��Ʒ�ļ�\��ʾͼƬ\ER-OLED0.96-1..bmp  --*/
/*--  ����x�߶�=128x64  --*/
...
int randTvar = 0;
  	...
  	// vytvorenie r�mu a vyplnit vsetko ine na ciernu farbu
