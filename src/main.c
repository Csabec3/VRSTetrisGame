...
/*--  ÎÄ×Ö:  Éî  --*/
/*--  ËÎĚĺ12;  ´Ë×ÖĚĺĎÂ¶ÔÓ¦µÄµăŐóÎŞŁşżíx¸ß=16x16   --*/
...
unsigned char pic[]=
{/*--  µ÷ČëÁËŇ»·ůÍĽĎńŁşE:\˛úĆ·ÎÄĽţ\ĎÔĘľÍĽĆ¬\ER-OLED0.96-1..bmp  --*/
/*--  żí¶Čx¸ß¶Č=128x64  --*/
...
unsigned char pic1[]=
{/*--  µ÷ČëÁËŇ»·ůÍĽĎńŁşD:\liu\ĎÔĘľÍĽĆ¬\12864LOGO.bmp  --*/
/*--  żí¶Čx¸ß¶Č=128x64  --*/
...
/*--  µ÷ČëÁËŇ»·ůÍĽĎńŁşD:\liu\ĎÔĘľÍĽĆ¬\128642.bmp  --*/
/*--  żí¶Čx¸ß¶Č=128x64  --*/
...
unsigned char pic3[]=
{
/*--  µ÷ČëÁËŇ»·ůÍĽĎńŁşD:\liu\ĎÔĘľÍĽĆ¬\12864a.bmp  --*/
/*--  żí¶Čx¸ß¶Č=128x64  --*/
...
unsigned char pic4[]=
{/*--  µ÷ČëÁËŇ»·ůÍĽĎńŁşD:\liu\ĎÔĘľÍĽĆ¬\12864-.bmp  --*/
/*--  żí¶Čx¸ß¶Č=128x64  --*/
...
int main(void)
{
	...
	lcdClearDisplay(decodeRgbValue(0, 0, 0));
  	...
  	char cislo2[8];
  	//char tvary[10] = {0,2,2,3,4,5,6,1,3,5};
  	char tvary[1000] ;
  	...
  	// vytvorenie rámu a vyplnit vsetko ine na ciernu farbu
  ...
  while (1)
  {
	  ...
	  if ((AD_value>3601) && (AD_value<3700)){
		  //rotation(matrix, ballX[count], ballY[count]-6, length, height);
	  }
...
/*
	  ...
	  createBlock(matrix, ballX[count], ballY[count], length, height, cisloTvaru);
	  Delay(1000);
